...
\keywords{optics, light, solar, NUV, sun-climate, irradiance}
...
%The major components of the telescope are multi-operation entrance-door, a thermal filter at the entrance aperture to control the amount of incomingsunlight, primary and secondary mirrors, a shuttermechanism to control exposures, baffles to reduce scattering and stray light, a vane shutter mechanism, spectral filters mounted on two motorized filter wheels, a field corrector lens on a moving stage, CCD detector. Fig \ref{fig:suit} shows a schematic diagram of the payload.
